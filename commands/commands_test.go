...
func TestShouldFreezeResources(t *testing.T) {
	...
	assert.True(t, pathExists("../hello/.freezer/github-com-fatih-color-9131ab34cf20d2f6d83fdc67168a5430d1c7dc23.tar"))
	assert.True(t, pathExists("../hello/.freezer/github-com-mattn-go-colorable-acb9493f2794fd0f820de7a27a217dafbb1b65ea.tar"))
	assert.True(t, pathExists("../hello/.freezer/github-com-mattn-go-isatty-57fdcb988a5c543893cc61bce354a6e24ab70022.tar"))
	assert.True(t, pathExists("../hello/.freezer/golang-org-x-sys-unix-99f16d856c9836c42d24e7ab64ea72916925fa97.tar"))
